...
const getCasts = function(castList){
    ...
    for(let i = 0, len = castList.lenght; i < len && i < 10; i++) {
...
fetchData(`https://api.themoviedb.org/3/movie/${movieId}?api_key=${apiKey}&append_to_response=casts,
videos,images,releases`, function (movie){
    ...
    fetchData(`https://api.themoviedb.org/3/movie/${movieId}/recommendations?api_key=${apiKey}&page=1`, addSuggestedMovies);
